...
var import_fast_csv = __toESM(require("fast-csv"));
var import_ldapjs = __toESM(require("ldapjs"));
...
var import_soap = __toESM(require("soap"));
...
var api = {
  ...
  getDocumentMetadata: (name) => {
    return {};
  },
  getFileURL: (name) => {
    return [];
  },
  getPrivateFileURL: (name) => {
    return [];
  },
  getESignInfo: () => {
    return [];
  },
  overwriteVariable: (name, value) => {
  },
  env: (name) => {
    return "";
  },
  lookupVariables: (appCode, variables, targetTeams) => __async(void 0, null, function* () {
    return {
      payload: [],
      totalCount: 0
    };
  ...
  makeRequest: (config) => (0, import_axios.default)(config),
  knex: import_knex.default,
  lodash: import_lodash.default,
  validator: import_validator.default,
  ldapjs: import_ldapjs.default,
  google: import_googleapis.google,
  csv: import_fast_csv.default,
  AWS: import_aws_sdk.default,
  https: import_https.default,
  http: import_http.default,
  url: import_url.default,
  stream: import_stream.default,
  soap: import_soap.default,
  xml2js: import_xml2js.default,
